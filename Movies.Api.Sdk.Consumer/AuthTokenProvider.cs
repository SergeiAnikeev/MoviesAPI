    ...
    public class AuthTokenProvider
    {
        ...
        public async Task<string> GetTokenAsync()
        {
            if (!string.IsNullOrEmpty(_cachedToken)){
                ...
                var expiryDateTime = UnixTimeStamToDateStamp(int.Parse(expiryTimeText));
        ...
        private static DateTime UnixTimeStamToDateStamp(int unixTimeStamp)
        {
